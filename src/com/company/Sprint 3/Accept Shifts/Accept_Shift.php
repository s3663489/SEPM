...
<body>
<form class="well form-horizontal" action="Accepted_Shift.php" method = "POST" onsubmit="return confirm('Are you sure you want to accept shift?');">
<label for="shifts">Choose a shift to accept from dropdown:</label>
